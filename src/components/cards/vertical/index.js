...
const VerticalCard = ({ product }) => {
    ...
    const handleAdd = useCallback(() => dispatch(addToCart({ ...product })) , [dispatch, product]);
    const handleRemove = useCallback(() => dispatch(removeFromCart(product)), [dispatch, product]);
